...
{
    public abstract class DosRepository<T> where T : Entity
    {
        static DosRepository()
        {
        ...
        {
            var result = Db.Context.From<T>().Top(top).ToList();
            return result;
        }
        /// <summary>
        /// 通用查询
        /// </summary>
        public static List<T> Query(Expression<Func<T, bool>> where, Expression<Func<T, object>> orderBy = null, string ascOrDesc = "asc", int? top = null, int? pageSize = null, int? pageIndex = null, int? cache = null)
        {
            ...
            if (cache != null)
            {
                fs.SetCacheTimeOut(cache.Value);
            }
            return fs.ToList();
        }
        /// <summary>
        /// 通用查询
        /// </summary>
        public static List<T> Query(Where<T> where, Expression<Func<T, object>> orderBy = null, string ascOrDesc = "asc", int? top = null, int? pageSize = null, int? pageIndex = null, int? cache = null)
        {
            var fs = Db.Context.From<T>().Where(where);
            if (top != null)
            {
        ...
        /// 通用查询
        /// </summary>
        public static List<T> Query(Where<T> where, OrderByClip orderBy = null, string ascOrDesc = "asc", int? top = null, int? pageSize = null, int? pageIndex = null, int? cache = null)
        {
            var fs = Db.Context.From<T>().Where(where);
            if (top != null)
            {
